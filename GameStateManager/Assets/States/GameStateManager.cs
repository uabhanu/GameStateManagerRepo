namespace States
{
    ...
    public class GameStateManager : MonoBehaviour
    {
        ...
        {
            _availableStatesDict = new Dictionary<System.Type , GameState>()
            {
                { typeof(MenuState) , new MenuState(this) } , { typeof(GameplayState) , new GameplayState(this) } , { typeof(GameOverState) , new GameOverState(this) }
            };
        }
